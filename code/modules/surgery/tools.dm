...
/obj/item/weapon/scalpel/chain
	name = "chain scalpel"
	icon_state = "chain_scalpel"
	force = 20.0
...
/obj/item/weapon/surgical_drapes //TODO: Make a makeshift version of these so people can actually perform a surgery on a table if they wish to.
...
/obj/item/weapon/scalpel/chain/cyber/dropped()
	qdel(src)
