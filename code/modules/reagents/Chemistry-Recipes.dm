...
/datum/chemical_reaction/napalm //TODO: Redo this.
	name = "Napalm"
	id = "napalm"
	result = null
...
/datum/chemical_reaction/napalm/on_reaction(var/datum/reagents/holder, var/created_volume)
	...
	for(var/turf/target in view(6, T)) //Just makes a long lasting fireball since I don't think flame processing will work anymore.
		if(!locate(/obj/effect/hotspot) in target)
			new /obj/effect/hotspot(target)
			target.temperature += created_volume*10
...
/datum/chemical_reaction/rezadone
	...
	id = "rezadone"
	result = "rezadone"
	required_reagents = list("legecillin" = 1, "cryptobiolin" = 1, "copper" = 1)
	result_amount = 3
...
/datum/chemical_reaction/khornedrink
	name = "Khornate Rum"
	id = "khornedrink"
	result = "khornedrink"
	required_reagents = list("gargleblaster" = 1, "blood" = 1)
	result_amount = 2

/datum/chemical_reaction/tzeenchdrink
	name = "Tzeench's Secret Brew"
	id = "tzeenchdrink"
	result = "tzeenchdrink"
	required_reagents = list("gargleblaster" = 1, "radium" = 1)
	result_amount = 2

/datum/chemical_reaction/slaaneshdrink
	name = "Slaaneshi Shot"
	id = "slaaneshdrink"
	result = "slaaneshdrink"
	required_reagents = list("gargleblaster" = 1, "hallucinations" = 1)
	result_amount = 2

/datum/chemical_reaction/nurgledrink
	name = "Nurgle's Filth"
	id = "nurgledrink"
	result = "nurgledrink"
	required_reagents = list("gargleblaster" = 1, "virusfood" = 1)
	result_amount = 2
...
/datum/chemical_reaction/damassine
	name = "Damassine"
	id = "damassine"
	result = "damassine"
	required_reagents = list("gin" = 1, "tea" = 1, "sugar" = 1)
	result_amount = 3
...
/datum/chemical_reaction/wildsnake
	name = "Wildsnake"
	id = "wildsnake"
	result = "wildsnake"
	required_reagents = list("vodka" = 1, "tequilla" = 1, "rotgut" = 1, "kahlua" = 1)
	result_amount = 4

/datum/chemical_reaction/tranq
	name = "Tranq"
	id = "tranq"
	result = "tranq"
