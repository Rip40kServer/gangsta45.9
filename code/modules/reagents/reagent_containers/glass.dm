...
/obj/item/weapon/reagent_containers/glass
	...
	afterattack(obj/target, mob/living/user, proximity)
		...
		if(ismob(target) && target.reagents && reagents.total_volume)
			...
			user.reagent_exposure(M, reagents, 0)
...
/obj/item/weapon/reagent_containers/glass/beaker/erelenmyre
	name = "Erlenmyre Flask"
	icon_state = "erlenmyre"
	volume = 60
	amount_per_transfer_from_this = 10
	possible_transfer_amounts = list(2,5,10,15,30)
	flags = OPENCONTAINER

/obj/item/weapon/reagent_containers/glass/beaker/round
	name = "Round Flask"
	icon_state = "round"
	volume = 40
	amount_per_transfer_from_this = 10
	possible_transfer_amounts = list(10,20,40)
	flags = OPENCONTAINER
