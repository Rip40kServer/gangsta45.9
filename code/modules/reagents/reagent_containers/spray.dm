...
/obj/item/weapon/reagent_containers/spray/afterattack(atom/A as mob|obj, mob/living/user as mob)
	...
	spawn(0)
		for(var/i=0, i<spray_currentrange, i++)
			...
			for(var/atom/T in get_turf(D))
				if(ismob(T))
					user.reagent_exposure(T, D.reagents, 0)
...
/obj/item/weapon/reagent_containers/spray/chemsprayer/afterattack(atom/A as mob|obj, mob/living/user as mob)
	if(istype(A, /obj/item/weapon/storage) || istype(A, /obj/structure/table) || istype(A, /obj/structure/rack) || istype(A, /obj/structure/closet) \
