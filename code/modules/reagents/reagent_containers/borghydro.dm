...
/obj/item/weapon/reagent_containers/borghypo
	...
	var/list/reagent_ids = list("doctorsdelight", "epinephrine", "legecillin", "revival", "morphine") //Buffed mixture that can actually help matters.
