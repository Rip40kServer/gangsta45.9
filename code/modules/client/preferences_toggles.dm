...
var/list/ghost_forms = list("ghost","ghostking","ghostian2","ghost_fire","ghost_dark", \
							"watcher","revenant_idle","spirit", "ghost_camo","ghost_red","ghost_dred") //Lets give them a slightly different set of forms to reflect the more significant role of the "ghost world"
