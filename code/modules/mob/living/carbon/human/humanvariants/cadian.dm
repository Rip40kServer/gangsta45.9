/mob/living/carbon/human/cadian
	name = "Unknown"
	real_name = "Unknown"
	universal_speak = 1
	gender = "male"

/mob/living/carbon/human/cadian/New()
	..()
	sleep (5)
	...
	equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/automatic/lasgun, slot_l_hand)
	...
	equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/impguard, slot_back)
