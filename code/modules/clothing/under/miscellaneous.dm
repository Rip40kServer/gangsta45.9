...
/obj/item/clothing/under/taum
	name = "Tau Jumpsuit"
	desc = "A standard issue jumpsuit for the Tau Fire Caste."
	icon_state = "taumale"
	item_state = "taumale"
	item_color = "taumale"
	gender = PLURAL
...
/obj/item/clothing/under/tauf
	name = "Tau Jumpsuit"
	desc = "A standard issue jumpsuit for the Tau Fire Caste."
	icon_state = "taufemale"
	item_state = "taufemale"
	item_color = "taufemale"
	gender = PLURAL
	body_parts_covered = GROIN|LEGS
	fitted = 0
	can_roll = 0
/*
/obj/item/clothing/under/eldar
	name = "Eldar Armor"
	desc = "If you could call it that."
	icon = 'icons/mob/eldarclothes.dmi'
	icon_state = "armor"
	item_state = "armor"
	gender = PLURAL
	body_parts_covered = GROIN|LEGS
