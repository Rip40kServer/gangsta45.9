...
/obj/item/weapon/gun/projectile/automatic/autogun2/attack_self(mob/living/user as mob) //TODO: Redo rapid fire for all guns but flamers and ork guns. Redo gun attachments.
	if(select_fire == 1)
		user << "\red You switch the [src.name] from semi-automatic to three round burst."
		select_fire = 3
