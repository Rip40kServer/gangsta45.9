		...
		convert()
			...
			for(var/mob/living/carbon/M in src.loc)
				...
				if(cultsinrange.len >= 1)
					...
					if(M.mind && (M.mind.special_role == "Genestealer Cult Member" || M.mind.special_role == "Changeling" || istype(M, /mob/living/carbon/human/tau))) //The person you are trying to cult is incapable of being twisted by chaos.
						...
						return 0
					if(isork(M))
						M << "\red <b>WAT DAT?! SOMETIN TRYNA MIND KONTROL YA BUT IT AINT WORKIN!</b>"
						M.visible_message("<b>[M]</b> scratches it's head in confusion, then shrugs.")
						return 0
