...
/client/verb/ooc(msg as text)
	...
	if(ooc_cooldown)
		src << "\red Slow down! You can only say something on OOC every three seconds."
	ooc_cooldown = 1
	spawn(30) ooc_cooldown = 0
...
/client/verb/looc(msg as text)
	...
	if(istype(mob, /mob/dead/observer))
		src << "\red Ghosts do not have access to LOOC."
		return
