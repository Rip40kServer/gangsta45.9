/obj/effect/proc_holder/spell/targeted/preacher/emperorswill
	name = "The Emperor's Will"
	desc = "Pray to the Emperor."
	school = "faith"
	panel = "Faith"
	invocation = "none"
...
/obj/effect/proc_holder/spell/targeted/preacher/emperorswill/cast(list/targets)
	for(var/mob/living/carbon/human/U in targets)
		...
		switch(U.purity)
			if( -1000 to 0)
				U << text("<span class='notice'>You return your thoughts to the Emperor and his devine will.</span>")
				U.purity = 0
			if(0)
				U << text("<span class='notice'>The Holy Emperor of mankind. A spiritu dominatus...</span>")
				U.say ("Domine, libra nos,")
				U.purity++
/*
			if(1)
...
/obj/effect/proc_holder/spell/targeted/mime/stealth/cast(list/targets)
	if ("STEALTHJAMMED" in roundevents)
		src << "\red Something nearby is disrupting your device..."
		return
	for(var/mob/living/carbon/human/U in targets)
